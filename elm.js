...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.TodoStatus":{"args":[],"tags":{"Incomplete":[],"Complete":[]}},"Main.Msg":{"args":[],"tags":{"ToggleTodo":["Int"],"FilterTodos":["Main.Filter"],"RemoveTodo":["Int"],"AddTodo":["Main.Todo"],"SetInput":["String"]}},"Main.Filter":{"args":[],"tags":{"By":["Main.TodoStatus"],"All":[]}}},"aliases":{"Main.Todo":{"args":[],"type":"{ id : Int, label : String, status : Main.TodoStatus }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
